 ...
 */
				this.find = function(query){
					this.elements = dom.get(this.elements[0], query);
					return this;
				};
				this.next = function(){
...
```
 ...
 console.log(
    ax5.dom.get_parent(e.target, {tagname:"a", clazz:"ax-menu-handel", "data-custom-attr":"attr_value"})
 );
 ```
		 */
		function get_parent(target, cond){
			var _target = target;
			if (_target) {
				while ((function(){
					var result = true;
